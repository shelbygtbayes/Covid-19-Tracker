                    ...
                    <Grid item component={Card} className={cx(styles.card , styles.confirmed)}>
                        <CardContent>
                            <Grid container spacing={3} justify="center">
                                <Grid item >
                                    <Typography align = "center" color="textSecondary" variant="h5" styles="font-family: 'Poppins', sans-serif;">Confirmed</Typography>
                                </Grid>
                                <Grid item>                               
                                ...
                                <Grid container justify="space-around">
                                    <Grid item xs = {6}  md={3} align="center">
                                        <CircularProgressbar className={styles.recoveryRate} value={recovery_rate} text={`${recovery_rate}`.slice(0,5)+'%'}  styles={buildStyles({
                                                                strokeLinecap: 'butt',
                                    ...
                                    <Grid item xs = {6}  md={3} align="center">
                                        <CircularProgressbar className={styles.MortalityRate} value={mortality_rate} text={`${mortality_rate}`.slice(0,5)+'%'}  styles={buildStyles({
                                                                    strokeLinecap: 'butt',
                                                                    pathTransitionDuration: 0.5,
                                                                    pathColor: `rgba(255, 0, 0, ${mortality_rate / 100})`,
                                                                    trailColor: '#d6d6d6',
                                                                    backgroundColor: '#3e98c7',
                                                                })}
                                                                />
